package com.xiaowenshuma.twocode;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        switch (view.getId()){
            ...
            case R.id.bt_save:
                ...
                if(!("".equals(hq_number)||"".equals(hq_password))  ){
                    if(hq_password.length()<4){
                        Toast.makeText(MainActivity.this,"密码不足4位",Toast.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    Toast.makeText(MainActivity.this,"请确认扫码成功并输入密码",Toast.LENGTH_SHORT).show();
    ...
    private void showpasswordcount() {
        ...
        tv_passwordcount.setText("你现在拥有"+passwordcount+"个密码");
    }
            ...
            case 1:
                if(resultCode==RESULT_OK){  //根据其他活动发送的结果码来获取数据
                    ...
                    if(list.size()==1){
                        ...
                        Toast.makeText(MainActivity.this,"恭喜密码是:"+intpassword,Toast.LENGTH_LONG).show();
                    }else {
                        password.setText("");
                        Toast.makeText(MainActivity.this,"积少成多,保存密码,努力吧",Toast.LENGTH_LONG).show();
                    }
